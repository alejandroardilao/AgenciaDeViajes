            					...
            					<div class="meta-info">
            						<?php 
                                        if( ( isset( $meta['trip_duration'] ) && '' != $meta['trip_duration'] ) || ( isset( $meta['trip_duration_nights'] ) ) && '' != $meta['trip_duration_nights'] ){ 
                                            ...
                                            if( $meta['trip_duration'] ) printf( esc_html( _nx( '%1$s Day', '%1$s Days', absint( $meta['trip_duration'] ), 'trip duration', 'travel-agency-companion' ) ), absint( $meta['trip_duration'] ) );
                                            if( $meta['trip_duration_nights'] ) printf( esc_html( _nx( ' - %1$s Night', ' - %1$s Nights', absint( $meta['trip_duration_nights'] ), 'trip duration night', 'travel-agency-companion' ) ), absint( $meta['trip_duration_nights'] ) ); 
                                            echo '</span>';                                       
                                        }
                                    ?>
            					</div>
