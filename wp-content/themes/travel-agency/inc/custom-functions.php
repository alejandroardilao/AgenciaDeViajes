...
function travel_agency_change_comment_form_default_fields( $fields ){
    ...
    $fields['author'] = '<p class="comment-form-author"><label class="screen-reader-text" for="author">' . esc_html__( 'Name*', 'travel-agency' ) . '</label><input id="author" name="author" placeholder="' . esc_attr__( 'Name*', 'travel-agency' ) . '" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>';
    
    $fields['email'] = '<p class="comment-form-email"><label class="screen-reader-text" for="email">' . esc_html__( 'Email*', 'travel-agency' ) . '</label><input id="email" name="email" placeholder="' . esc_attr__( 'Email*', 'travel-agency' ) . '" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';
...
function travel_agency_change_comment_form_defaults( $defaults ){
    ...
    $defaults['comment_field'] = '<p class="comment-form-comment"><label class="screen-reader-text" for="comment">' . esc_html__( 'Comment', 'travel-agency' ) . '</label><textarea id="comment" name="comment" placeholder="' . esc_attr__( 'Comment', 'travel-agency' ) . '" cols="45" rows="8" aria-required="true"></textarea></p>';
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'travel-agency' ), $name ) ; ?></p>
...
if( ! function_exists( 'travel_agency_restore_admin_notice' ) ) :
/**
 * Restoring admin notice on theme switch
 */
function travel_agency_restore_admin_notice(){
    update_option( 'travel_agency_admin_notice', false );
}
endif;
add_action( 'after_switch_theme', 'travel_agency_restore_admin_notice' );